...
const NewUsers = () => {
  ...
  const { trigger: GetNewUser, loading: isMutating } = useApiMutation();
  const { trigger: GetNewUserByUid, loading: drawerLoading } = useApiMutation();
  ...
  const fetchUser = async () => {
    const res = await GetNewUser({ url: NEW_USERS });
  ...
  return (
    <Card>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
        <h2 className="text-2xl font-bold heading">New Users List</h2>
